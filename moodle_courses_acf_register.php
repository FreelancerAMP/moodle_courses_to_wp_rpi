        ...
        if (function_exists('acf_add_local_field_group')) {
            ...
            acf_add_local_field_group(array(
                ...
                'fields' => array(
                    ...
                    array(
                        'key' => 'field_tab_moodle_courses_template',
                        'label' => 'Courses display template',
                        'name' => '',
                        'type' => 'tab',
                        'instructions' => '',
                        'required' => 0,
                    ...
                    array(
                        'key' => 'field_moodle_custom_template_toggle',
                        'label' => 'Courses Custom Template enable',
                        'name' => 'moodle_courses_custom_template_toggle',
                        'type' => 'true_false',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_moodle_courses_custom_template',
                        'label' => 'Courses Custom Template',
                        'name' => 'moodle_courses_custom_template',
                        'type' => 'acfe_code_editor',
                        'instructions' => 'These variables may be used: ' . implode(', ', MoodleCoursesToRpi::$replacment),
                        'required' => 0,
                        'conditional_logic' => array(
                            array(
                                array(
                                    'field' => 'field_moodle_custom_template_toggle',
                                    'operator' => '==',
                                    'value' => '1',
                                ),
                            ),
                    ...
                    array(
                        'key' => 'field_moodle_courses_custom_styles',
                        'label' => 'Courses Custom Styles',
                        'name' => 'moodle_courses_custom_styles',
                        'type' => 'acfe_code_editor',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => array(
                    ...
                    array(
                        'key' => 'field_tab_moodle_shortcode_generator',
